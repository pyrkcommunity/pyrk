...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Pyrk address\n"
            "  payee          - Print the masternode payout Pyrk address (can be additionally filtered,\n"
            "                   partial match)\n"
            ...
            "  votingaddress  - Print the masternode voting Pyrk address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "pyrk",               "masternode",             &masternode,             true,  {} },
    { "pyrk",               "masternodelist",         &masternodelist,         true,  {} },
    { "pyrk",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "pyrk",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "pyrk",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "pyrk",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
