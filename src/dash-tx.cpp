...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pyrk-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pyrk-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pyrk transaction") + "\n" +
              "  pyrk-tx [options] -create [commands]   " + _("Create hex-encoded pyrk transaction") + "\n" +
              "\n";
