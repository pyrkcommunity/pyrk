...
The introduction of special transactions will require the whole Pyrk ecosystem to perform a one-time mandatory update of all the software and libraries involved.
